...
/* NH_EXTRAM routes these into PSRAM on the ESP32-S3 cross build (no-op on
 * host).  Reserves ~200 KB of internal DRAM that would otherwise overflow
 * the chip's 320 KB. */
NH_EXTRAM struct instance_globals_a ga;
NH_EXTRAM struct instance_globals_b gb;
NH_EXTRAM struct instance_globals_c gc;
NH_EXTRAM struct instance_globals_d gd;
NH_EXTRAM struct instance_globals_e ge;
NH_EXTRAM struct instance_globals_f gf;
NH_EXTRAM struct instance_globals_g gg;
NH_EXTRAM struct instance_globals_h gh;
NH_EXTRAM struct instance_globals_i gi;
NH_EXTRAM struct instance_globals_j gj;
NH_EXTRAM struct instance_globals_k gk;
NH_EXTRAM struct instance_globals_l gl;
NH_EXTRAM struct instance_globals_m gm;
NH_EXTRAM struct instance_globals_n gn;
NH_EXTRAM struct instance_globals_o go;
NH_EXTRAM struct instance_globals_p gp;
NH_EXTRAM struct instance_globals_q gq;
NH_EXTRAM struct instance_globals_r gr;
NH_EXTRAM struct instance_globals_s gs;
NH_EXTRAM struct instance_globals_t gt;
NH_EXTRAM struct instance_globals_u gu;
NH_EXTRAM struct instance_globals_v gv;
NH_EXTRAM struct instance_globals_w gw;
NH_EXTRAM struct instance_globals_x gx;
NH_EXTRAM struct instance_globals_y gy;
NH_EXTRAM struct instance_globals_z gz;
NH_EXTRAM struct instance_globals_saved_b svb;
NH_EXTRAM struct instance_globals_saved_c svc;
NH_EXTRAM struct instance_globals_saved_d svd;
NH_EXTRAM struct instance_globals_saved_e sve;
NH_EXTRAM struct instance_globals_saved_h svh;
NH_EXTRAM struct instance_globals_saved_i svi;
NH_EXTRAM struct instance_globals_saved_k svk;
NH_EXTRAM struct instance_globals_saved_l svl;
NH_EXTRAM struct instance_globals_saved_m svm;
NH_EXTRAM struct instance_globals_saved_n svn;
NH_EXTRAM struct instance_globals_saved_o svo;
NH_EXTRAM struct instance_globals_saved_p svp;
NH_EXTRAM struct instance_globals_saved_q svq;
NH_EXTRAM struct instance_globals_saved_r svr;
NH_EXTRAM struct instance_globals_saved_s svs;
NH_EXTRAM struct instance_globals_saved_t svt;
NH_EXTRAM struct instance_globals_saved_u svu;
NH_EXTRAM struct instance_globals_saved_w svw;
